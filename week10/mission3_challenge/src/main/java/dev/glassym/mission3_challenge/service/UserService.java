package dev.glassym.mission3_challenge.service;
...
import dev.glassym.mission3_challenge.repository.AreaRepository;
import dev.glassym.mission3_challenge.repository.UserRepository;
...
public class UserService {
    ...
    public UserDto createUser(UserDto dto){
        Optional<AreaEntity> areaEntityOptional = this.areaRepository.findById(dto.getId());
        ...
        userEntity.setShopOwner(dto.getShopOwner());
    ...
    public void updateUser(Long id, UserDto dto){
        ...
        Optional<AreaEntity> newArea = this.areaRepository.findById(
                dto.getId() == null ? userEntity.getResidence().getId() : dto.getResidence());
